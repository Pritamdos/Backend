                                                     ...
                                                     <div class="get-each-sec">
                                                      ...
                                                      <div class="get-each-sec">
                                                         ...
                                                         <div class="text-reason">
                                                             <textarea placeholder="Type your Query..." name="call_reason" id="call_reason" class="textareas" ></textarea>
                                                         </div>
                                                      </div>
                                                      <div class="get-each-sec">
                                                         <span class="reason-for-callback">
                                                        ...
                                                        <input type="time" name="call_time" id="call_time" required="true" />
                                                      </div>
                                                  </div>
...
<script>
 ...
 function add(){
	...
	var words = document.getElementById('page_msg2').value;
    words = words*1 + 250 ;
